...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = baseURL + "/jsp/3rd-plug/ueditor1_4_3-utf8-jsp/";
    var URL = window.UEDITOR_HOME_URL || baseURL + "/jsp/3rd-plug/ueditor1_4_3-utf8-jsp/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
//        , serverUrl: baseURL + "/dispatch?"+_csrf+"="+token
        , serverUrl: URL + "jsp/controller.jsp"+"?"+_csrf+"="+token
