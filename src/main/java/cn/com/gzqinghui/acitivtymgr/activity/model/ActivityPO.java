...
public class ActivityPO implements Serializable,IBaseEntity {
    private java.lang.String id ;
    private java.lang.String title ;
    private java.lang.String homepagep ;
    private java.util.Date endTime ;
    private java.lang.String isPushHomepage ;
    private java.lang.String activiyDesc ;
    ...
    public void setHomepagep(java.lang.String homepagep){
    this.homepagep=homepagep ;
    }

    
    
    public java.lang.String getHomepagep(){
    ...
    this.endTime=endTime ;
        ...
        this.endTime= (Date) ConvertUtils.convert(endTime,Date.class);
    }
    ...
    public void setIsPushHomepage(java.lang.String isPushHomepage){
    this.isPushHomepage=isPushHomepage ;
    }

    
    
    public java.lang.String getIsPushHomepage(){
       return this.isPushHomepage  ;
    }

    
    public void setActiviyDesc(java.lang.String activiyDesc){
    this.activiyDesc=activiyDesc ;
    }

    
    
    public java.lang.String getActiviyDesc(){
